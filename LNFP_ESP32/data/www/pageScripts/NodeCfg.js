...
function setDisplayOptions()
{
	...
	setVisibility(configWorkData.useDCC, modDCCConfig);
...
//				createCheckbox(tempObj, "tile-1_4", "Provide Access Point", "cbUseAP", "setUseAP(this)");
		...
		tempObj = createEmptyDiv(mainScrollBox, "div", "tile-1", "");
			createRadiobox(tempObj, "tile-1_4", "", ["Decoder Mode", "ALM Mode"], "selectworkmode", "setWorkMode(this, id)");
		...
		modALMOnly = createEmptyDiv(mainScrollBox, "div", "tile-1", "wifionlycontrolbox");
			tempObj = createEmptyDiv(modALMOnly, "div", "tile-1", "");
				createCheckbox(tempObj, "tile-1_4", "use Button Handler Module", "cbUseBtnHdlr", "setUseBtnHdlr(this)");
				tempObj = createEmptyDiv(modALMOnly, "div", "tile-1", "");
					createCheckbox(tempObj, "tile-1_4", "use HW Button Module", "cbUseHWBtn", "setUseHWBtn(this)");
				modHWBtnConfig = createEmptyDiv(modALMOnly, "div", "tile-1", "");
				modHWBtnConfig.style.display = "none";
					createTextInput(modHWBtnConfig, "tile-1_4", "Address Pins (4)", "n/a", "btnaddr", "setHWBtn(this)");
					createTextInput(modHWBtnConfig, "tile-1_4", "Data Pins (1-4)", "n/a", "btndata", "setHWBtn(this)");


		modDecoderOnly = createEmptyDiv(mainScrollBox, "div", "tile-1", "alwaysoncontrolbox");
			tempObj = createEmptyDiv(modDecoderOnly, "div", "tile-1", "");
				createCheckbox(tempObj, "tile-1_4", "use DCC Input Module", "cbUseDCC", "setUseDCC(this)");
			modDCCConfig = createEmptyDiv(modDecoderOnly, "div", "tile-1", "");
			modDCCConfig.style.display = "none";
				createTextInput(modDCCConfig, "tile-1_4", "DCC Rx Pin", "n/a", "dcc_rx", "setDCC(this)");
				createTextInput(modDCCConfig, "tile-1_4", "Ack Pin", "n/a", "dcc_ack", "setDCC(this)");


		modWifiALMOnly = createEmptyDiv(mainScrollBox, "div", "tile-1", "wifiALMcontrolbox");
			tempObj = createEmptyDiv(modWifiALMOnly, "div", "tile-1", "");
				createCheckbox(tempObj, "tile-1_4", "use Gateway Module", "cbUseGW", "setUseGateway(this)");
...
function loadDataFields(jsonData)
{
	...
	writeCBInputField("cbUseDCC", jsonData.useDCC);
	setVisibility(jsonData.useDCC, modDCCConfig);
	writeInputField("dcc_rx", jsonData.DccConfig.DccInPin);
	writeInputField("dcc_ack", jsonData.DccConfig.DccAckPin);
