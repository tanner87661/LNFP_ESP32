...
{
//   Serial.printf("LN Msg %i ReqID %i RespID %i with %i bytes requested %i started %i completed %i: ", newData->errorFlags, newData->reqID, newData->respID, newData->lnExpLen, newData->reqRecTime, newData->txStartTime, newData->respTime); 
